...
Shader "Standard"
{
	...
	SubShader
	{
		...
		uniform sampler2D _Loft;
		uniform float4 _Loft_ST;

		void surf( Input i , inout SurfaceOutputStandard o )
		{
			float2 uv_Loft = i.uv_texcoord * _Loft_ST.xy + _Loft_ST.zw;
			o.Albedo = tex2D( _Loft, uv_Loft ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=17900
-35;182;1920;995;1043;390.5;1;True;True
Node;AmplifyShaderEditor.SamplerNode;1;-515,-22.5;Inherit;True;Property;_Loft;Loft;0;0;Create;True;0;0;False;0;-1;c2c7778ea9156f6449c5d8054cb75a4e;c2c7778ea9156f6449c5d8054cb75a4e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=7B1E040FDC298555BD7C6D663C4D89144CFAC356